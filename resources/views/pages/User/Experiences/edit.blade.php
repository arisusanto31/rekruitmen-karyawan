                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="last_job_departement" id="last_job_departement"
                                    ...
                                    placeholder="Departement Name" value="{{$experiences->last_job_departement}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="company_name" id="company_name"
                                    ...
                                    placeholder="Company Name" value="{{$experiences->company_name}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="last_job_position" id="last_job_position"
                                    ...
                                    placeholder="Last Job Position" value="{{$experiences->last_job_position}}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="month" name="start_job" id="start_job"
                                            ...
                                            placeholder="Start Job" value="{{$experiences->start_job}}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="month" name="end_job" id="end_job"
                                            ...
                                            placeholder="End Job" value="{{$experiences->end_job}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="salary" id="salary"
                                    ...
                                    placeholder="Salary" value="{{$experiences->salary}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="intensive_pay" id="intensive_pay"
                                    class="form-control {{ $errors->first('intensive_pay') != null ? 'is-invalid' : '' }}"
                                    placeholder="Intensive Pay" value="{{$experiences->intensive_pay}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="last_job_facility" id="last_job_facility"
                                    ...
                                    placeholder="Last Job Facility" value="{{$experiences->last_job_facility}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="reason_stop_working" id="reason_stop_working" class="form-control {{ $errors->first('reason_stop_working') != null ? 'is-invalid' : '' }}" cols="30" rows="10" placeholder="Reason Stop Working">{{$experiences->reason_stop_working}}</textarea>
