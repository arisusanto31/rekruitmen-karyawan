                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="training" id="training"
                                    ...
                                    placeholder="Training Name" value="{{$trainings->training}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="certification" id="certification"
                                    ...
                                    placeholder="Certification" value="{{$trainings->certification}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="organizer" id="organizer"
                                    ...
                                    placeholder="Organizer" value="{{$trainings->organizer}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="1900" max="2100" step="1" value="{{date('Y')}}" name="year_of_training" id="year_of_training"
                                    ...
                                    placeholder="Organizer" value="{{$trainings->year_of_training}}" required>
