                            ...
                            <table class="table table-hover table-lg" id="table1">
                                ...
                                @foreach ($test as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('delete_test',$item->id)}}" method="post">
                                                @method('DELETE')
                                                @csrf
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Create Test </h4>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <i data-feather="x"></i>
                        </button>
                    </div>
                    <form action="{{route('store_test')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('POST')
        ...
        @foreach ($test as $item)
            <div class="modal fade text-left" id="modalEdit-{{$item->id}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel33">Edit Test </h4>
                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                <i data-feather="x"></i>
                            </button>
                        </div>
                        <form action="{{route('update_test',$item->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="modal-body">
                                <div class="form-group">
