                    ...
                    <form action="{{route('departement.update',$departement->id)}}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="departement" id="departement" value="{{$departement->departement}}" class="form-control  {{ $errors->first('departement') != null ? 'is-invalid' : '' }}" placeholder="Departement Name" required>
